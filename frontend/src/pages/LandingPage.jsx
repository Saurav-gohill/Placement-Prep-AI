      ...
      <main className="relative flex-grow">
        ...
        <section className="relative min-h-screen pt-32 pb-20 hero-gradient">
          ...
          <div className="max-w-7xl mx-auto px-8 grid lg:grid-cols-2 gap-12 items-center relative z-10">
            <div className="z-10">
              ...
              <h1 className="text-5xl lg:text-7xl font-headline font-extrabold tracking-tight leading-tight text-on-surface mb-8 anim-fade-in-up anim-delay-2">
              ...
              <p className="text-lg text-on-surface-variant max-w-lg mb-10 leading-relaxed anim-fade-in-up anim-delay-3">
              ...
              <div className="flex flex-wrap gap-4 anim-fade-in-up anim-delay-4">
                  <Link to="/signup" className="px-8 py-4 bg-gradient-to-r from-primary-container to-secondary-container rounded-xl font-headline font-bold text-white transition-all hover:opacity-90 active:scale-95">
                      Start Preparation Now
                  </Link>
                  <Link to="/pricing" className="px-8 py-4 bg-surface-bright/50 glass-edge rounded-xl font-headline font-bold text-on-surface hover:bg-surface-bright transition-all active:scale-95">
                      View Plans
                  </Link>
              </div>
            </div>
        ...
        <section className="py-24 max-w-7xl mx-auto px-8 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[280px]">
                ...
                {/* Resume Analyzer */}
                <Link to="/signup" className="md:col-span-7 bg-surface-container-low rounded-xl glass-edge p-8 group hover:scale-[1.02] transition-all duration-500 flex flex-col justify-between overflow-hidden relative anim-hover-lift">
                    <div className="z-10">
                ...
                {/* AI Mock Interview */}
                <Link to="/signup" className="md:col-span-5 md:row-span-2 bg-surface-container-high rounded-xl glass-edge p-8 group hover:scale-[1.02] transition-all duration-500 flex flex-col relative overflow-hidden anim-hover-lift">
                ...
                {/* Coding Practice */}
                <Link to="/signup" className="md:col-span-4 bg-surface-container-low rounded-xl glass-edge p-8 group hover:scale-[1.02] transition-all duration-500 flex flex-col relative overflow-hidden anim-hover-lift">
                ...
                {/* Aptitude */}
                <Link to="/signup" className="md:col-span-3 bg-surface-container-low rounded-xl glass-edge p-8 group hover:scale-[1.02] transition-all duration-500 flex flex-col relative overflow-hidden anim-hover-lift">
          ...
          <div className="max-w-5xl mx-auto px-8">
            <div className="relative bg-gradient-to-br from-[#131b2e] to-[#0b1326] rounded-3xl p-12 lg:p-20 text-center glass-edge overflow-hidden shadow-2xl">
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 relative z-10">
                <Link to="/signup" className="px-10 py-5 bg-gradient-to-r from-primary-container to-secondary-container rounded-xl font-headline font-bold text-white shadow-xl shadow-primary-container/25 hover:scale-105 transition-transform active:scale-95">
                    Start Preparation Now
                </Link>
              </div>
            </div>
